...
function App() {
  const data = {
    main: {
      ...
      description:
        "At Abefe’s we are passionate about consistently offering first class quality food and services at competitive prices, while supporting local communities and continuously leading the way in the fresh food market.",
    ...
    <div className="box-border">
      <div className="flex flex-col">
        ...
        <AnimationOnScroll
          ...
          className="pt-20 mb-12 lg:mb-20 text-3xl font-semibold text-center text-gray-800 lg:font-bold dancing"
        >
          How the app works
        </AnimationOnScroll>
